{ config, ... }:
{
  ...
  home.file = {
    "/.config/i3/config".text = ''
      ...
      # bindcode $mod+40 exec "rofi -show drun -theme gruvbox-dark -show-icons -font "monospace 16""
      # bindcode $mod+40 exec "rofi -show drun -theme gruvbox-dark -show-icons -font \"monospace 16\""

      bindcode $mod+40 exec --no-startup-id rofi -show drun -theme gruvbox-dark -show-icons -font "monospace 16"
